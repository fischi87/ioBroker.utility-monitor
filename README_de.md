...
- **DOCS:** 🌐 **Englische Dokumentation** - Die README liegt jetzt auf Englisch vor, diese deutsche Fassung unter `README_de.md`. Alle Konfigurationstexte sind zusätzlich auf Englisch verfügbar.
...
Ältere Versionen findest du in [CHANGELOG_OLD.md](CHANGELOG_OLD.md).
